...
export default function Home(props) {
  return (
    <main className="font-sans antialiased bg-gray-950 min-h-screen">
      <ScrollExpandMedia
        mediaType="video"
        mediaSrc="https://videos.pexels.com/video-files/26772138/12003967_1920_1080_30fps.mp4"
        posterSrc="https://videos.pexels.com/video-files/26772138/12003967_1920_1080_30fps.jpg"
        ...
        textBlend={true}
      >
        <div className="w-full -mx-8 md:-mx-16 lg:-mx-0"> {/* Negative margin to offset container padding if needed, or just let it be center aligned */}
