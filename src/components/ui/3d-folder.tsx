    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            className="bg-folder-back absolute h-24 w-32 rounded-lg shadow-md"
            style={{
          ...
          <div
            className="bg-folder-tab absolute h-4 w-12 rounded-t-md"
            style={{
          ...
          <div
            className="bg-folder-front absolute h-24 w-32 rounded-lg shadow-lg"
            style={{
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          transform:
            animationPhase === 'complete' && !isClosing ? 'translateY(0)' : 'translateY(-10px)',
      ...
      <button
        ...
        style={{
          ...
          transform:
            animationPhase === 'complete' && !isClosing ? 'translateX(0)' : 'translateX(-20px)',
      ...
      >
        ...
        >
          <div className="relative overflow-hidden">
            ...
            >
              {projects.map((project, idx) => (
                <img
                  ...
                  alt={project.title}
                  className="bg-background h-auto max-h-[70vh] w-full flex-shrink-0 object-contain"
                  style={{ minWidth: '100%' }}
                />
              ))}
            </div>
            ...
            <div className="from-card/20 to-card/10 pointer-events-none absolute inset-0 bg-gradient-to-t via-transparent" />
          </div>
          ...
          <div
            ...
            style={{
              opacity: animationPhase === 'complete' && !isClosing ? 1 : 0,
              transform:
                animationPhase === 'complete' && !isClosing ? 'translateY(0)' : 'translateY(20px)',
    ...
    return (
      <div
        ...
        className={cn(
          ...
          'bg-card border-border border',
          'hover:ring-accent/50 cursor-pointer hover:ring-2',
      ...
      >
        ...
        <div className="from-foreground/60 absolute inset-0 bg-gradient-to-t to-transparent" />
