                ...
                <span
                  className={cn(
                    ...
                    isActive
                      ...
                      : 'opacity-40 grayscale group-hover:opacity-70 group-hover:grayscale-[0.3]'
                  )}
                >
                  {item.emoji}
                </span>
      ...
      <div className="relative h-7 w-32">
        ...
        <div
          className={cn(
            ...
            displayRating > 0 ? 'scale-95 opacity-0 blur-md' : 'blur-0 scale-100 opacity-100'
          )}
        >
          <span className="text-muted-foreground text-sm font-medium">Rate us</span>
        </div>
