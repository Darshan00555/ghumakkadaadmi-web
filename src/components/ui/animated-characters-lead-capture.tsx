...
export function LeadCapturePage({ onComplete }: { onComplete?: () => void }) {
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="from-primary/90 via-primary to-primary/80 text-primary-foreground relative hidden flex-col justify-between overflow-hidden bg-gradient-to-br p-12 lg:flex">
      ...
      <div className="bg-background flex items-center justify-center p-8">
        <div className="w-full max-w-[420px]">
          ...
          <div className="mb-10 text-center">
            <h1 className="mb-2 text-3xl font-bold tracking-tight">Join the Adventure!</h1>
            <p className="text-muted-foreground text-sm">Trip updates, guides, and more.</p>
          </div>
...
export const Component = LeadCapturePage;
